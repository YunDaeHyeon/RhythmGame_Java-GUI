...
public class DynamicBeat extends JFrame {
	...
	public void screenDraw(Graphics2D g) {
		...
		if(isGameScreen) {
			g.drawImage(noteRouteImage,228,30,null);  //노트 경로 이미지 그리기
			g.drawImage(noteRouteImage,332,30,null);  //노트 경로 이미지 그리기
			g.drawImage(noteRouteImage,436,30,null);  //노트 경로 이미지 그리기
			g.drawImage(noteRouteImage,540,30,null);  //노트 경로 이미지 그리기
			g.drawImage(noteRouteImage,640,30,null);  //노트 경로 이미지 그리기
			g.drawImage(noteRouteImage,744,30,null);  //노트 경로 이미지 그리기
			g.drawImage(noteRouteImage,848,30,null);  //노트 경로 이미지 그리기
			g.drawImage(noteRouteImage,952,30,null);  //노트 경로 이미지 그리기
