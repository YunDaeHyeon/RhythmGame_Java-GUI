...
public class DynamicBeat extends JFrame {
	...
	//곡 타이틀 이미지
	private Image titleImage = new ImageIcon(Main.class.getResource("../images/Totoro Title Image.png")).getImage();
	//곡 선택(오른쪽, 왼쪽) 버튼
	...
	//선택된 곡 선택
	private Image selectedImage  = new ImageIcon(Main.class.getResource("../images/Totoro Start Image.png")).getImage();
